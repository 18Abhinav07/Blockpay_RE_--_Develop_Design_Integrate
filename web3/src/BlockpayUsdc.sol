...
contract BlockpayUsdc is Ownable {
    ...
    uint256 private USD_LIQUIDITY; // In ether decimals of 18
        ...
        Ownable(msg.sender)
    {
        ...
        // MockUsdc(USDC).mint(address(swapRouter), 1000000 * 1e6);
    ...
    function fundContract() public payable {
        ...
        uint256 minAmountOut = expectedUSDC * (10000 - SLIPPAGE_TOLERANCE) / (10000 * USDC_DECIMALS * USDC_DECIMALS);
